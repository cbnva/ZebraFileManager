...
namespace ZebraFileManager.Zebra.ESC_POS_USB_NET.Helper
{
    internal class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, int dwCount)
        {
            ...
            if (OpenPrinter(szPrinterName.Normalize(), out hPrinter, IntPtr.Zero))
            {
                ...
                var result = GetPrinterData(hPrinter, "NLMOpenDoc", out junk, data, (uint)data.Length, out dataRetrieved);
                
                if(data.Length >= dataRetrieved && Encoding.UTF8.GetString(data, 0, (int)dataRetrieved) == "NLMOpenOk")
                {
                ...
                result = GetPrinterData(hPrinter, "NLMCloseDoc", out junk, data, (uint)data.Length, out dataRetrieved);
